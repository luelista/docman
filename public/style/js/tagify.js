...
Tagify.prototype = {
  ...
  DEFAULTS: {
    ...
    // join tags with this character to produce the value for original input field
    pattern: null,
  ...
  update: function update() {
    ...
    this.DOM.originalInput.value = this.settings.mode == 'mix' ? this.getMixedTagsAsString(value) : this.value.length ? this.settings.outputDelimiter ? value.map(function (_ref4) {
      var value = _ref4.value;
      return value;
    }).join(this.settings.outputDelimiter) : JSON.stringify(value) : "";
