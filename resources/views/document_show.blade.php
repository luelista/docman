...
<p><b><input type="date" name="doc_date" value="{{ ($doc->doc_date == null) ? "" : $doc->doc_date->toDateString() }}"></b></p>
	<p><input type="text" name="doc_mandant" value="{{ $doc->doc_mandant }}" size=10 placeholder=Mandant></p>
